...
GEN_PATHS = {
    'coqa': {
        ...
        'mistral-7b-hf': f'{GENERATION_FOLDER}/mistral-7b-hf_coqa_10/0.pkl', # Mistral-7B-Instruct-v0.2
   },
   'triviaqa': {
        'llama-13b-hf': f'{GENERATION_FOLDER}/llama-13b-hf_triviaqa_0/0.pkl',
        'mistral-7b-hf': f'{GENERATION_FOLDER}/mistral-7b-hf_triviaqa_10/0.pkl',  
   }
}
