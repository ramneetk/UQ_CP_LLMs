...
_BASE_DIR = f'/home/aciicsarl/UQ-NLG/'
LLAMA_PATH = f'/home/aciicsarl/'
MISTRAL_PATH = f'/home/aciicsarl/'

DATA_FOLDER = '/home/aciicsarl/ACI-SRI/' #os.path.join(_BASE_DIR, 'NLGUQ')
...
GEN_PATHS = {
    'coqa': {
        ...
        'llama3': f'{GENERATION_FOLDER}/Meta-Llama-3-8B-Instruct_coqa_10/0.pkl'
   },
#    'triviaqa': {
